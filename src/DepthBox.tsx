...
const DepthBox: React.FC<DepthBoxProps> = ({ bg = '#f0f0f0', children, index, onClick }) => {
...
continue;
  ...
  return (
    <MeshPortalMaterial  attach={`material-${index}`}>
      ...
      <group rotation={rotations[index]}  >
      ...
      <mesh castShadow receiveShadow ref={mesh} rotation={[0, 3.14 /2, 0]} onClick={clickHandler}  >
        {children}
